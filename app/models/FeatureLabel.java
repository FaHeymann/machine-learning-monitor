...
public class FeatureLabel extends TimestampedModel {
    ...
    @ManyToMany(mappedBy = "ignoredLabels")
    @JsonIgnore
    private List<ResultSet> ignoredIn;
    ...
    public List<ResultSet> getIgnoredIn() {
        return ignoredIn;
    }

    public void setIgnoredIn(final List<ResultSet> ignoredIn) {
        this.ignoredIn = ignoredIn;
    }
